...
final class SecurePaymentDialogFragment extends DialogFragment {
    ...
    private void buildRequestSecurePayment(){
        url3Ds = NetPay.getIntance().getUrlSecurePayment()
                ...
                + (NetPay.getIntance().getUserNetPayMovil() != null  ? "&Operator=" + NetPay.getIntance().getUserNetPayMovil() : "")
                + (NetPay.getIntance().getPasswordNetPayMovil() != null ? "&Channel=" + NetPay.getIntance().getPasswordNetPayMovil():"")
